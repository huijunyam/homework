	...
	var GiphysSearch = function (_React$Component) {
	  ...
	  _createClass(GiphysSearch, [{
	    ...
	    value: function handleSubmit(e) {
	      e.preventDefault();
	      this.props.fetchSearchGiphys(this.state.searchTerm.split(" ").join("+")).then(this.setState({ searchTerm: "" }));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'form',
	          null,
	          _react2.default.createElement('input', { onChange: this.handleChange.bind(this), type: 'text', value: this.state.searchTerm }),
	          _react2.default.createElement(
	            'button',
